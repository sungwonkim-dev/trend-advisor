...
public class Path {
    ...
    public static final String WEBDRIVER_74_PATH_IN_RESOURCE = "/webdriver/chromedriver.exe";
    public static final String WEBDRIVER_75_PATH_IN_RESOURCE = "/webdriver/chromedriver2.exe";
